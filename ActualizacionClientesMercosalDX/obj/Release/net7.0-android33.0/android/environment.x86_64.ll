...
@__app_environment_variables_v_1.3 = internal constant [37 x i8] c"4864ae78-33cc-430a-a75a-2f7cb0ebec2c\00", align 16
...
@__ApplicationConfig_android_package_name.0 = internal constant [47 x i8] c"com.companyname.ActualizacionClientesIdealMaui\00", align 16
...
@application_config = local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 33555361, ; android_runtime_jnienv_class_token
	i32 100673615, ; jnienv_initialize_method_token
	i32 100673614, ; jnienv_registerjninatives_method_token
...
@__DSOCacheEntry_name.2 = internal constant [45 x i8] c"libaot-ActualizacionClientesIdealMaui.dll.so\00", align 16
...
@__DSOCacheEntry_name.15 = internal constant [38 x i8] c"libaot-DevExpress.Android.Core.dll.so\00", align 16
...
@__DSOCacheEntry_name.26 = internal constant [43 x i8] c"libaot-DevExpress.Android.Scheduler.dll.so\00", align 16
...
@__DSOCacheEntry_name.30 = internal constant [36 x i8] c"libaot-System.Drawing.Common.dll.so\00", align 16
...
@__DSOCacheEntry_name.35 = internal constant [49 x i8] c"libaot-SQLitePCLRaw.lib.e_sqlite3.android.dll.so\00", align 16
@__DSOCacheEntry_name.36 = internal constant [44 x i8] c"libaot-Xamarin.AndroidX.DrawerLayout.dll.so\00", align 16
@__DSOCacheEntry_name.37 = internal constant [25 x i8] c"libaot-SQLite-net.dll.so\00", align 16
@__DSOCacheEntry_name.38 = internal constant [40 x i8] c"libaot-System.Runtime.Extensions.dll.so\00", align 16
@__DSOCacheEntry_name.39 = internal constant [27 x i8] c"libaot-Java.Interop.dll.so\00", align 16
@__DSOCacheEntry_name.40 = internal constant [48 x i8] c"libaot-Xamarin.AndroidX.Lifecycle.Common.dll.so\00", align 16
@__DSOCacheEntry_name.41 = internal constant [41 x i8] c"libaot-Microsoft.Win32.Primitives.dll.so\00", align 16
@__DSOCacheEntry_name.42 = internal constant [38 x i8] c"libaot-System.Linq.Expressions.dll.so\00", align 16
@__DSOCacheEntry_name.43 = internal constant [33 x i8] c"libaot-System.Collections.dll.so\00", align 16
@__DSOCacheEntry_name.44 = internal constant [52 x i8] c"libaot-Microsoft.Maui.Controls.Compatibility.dll.so\00", align 16
@__DSOCacheEntry_name.45 = internal constant [36 x i8] c"libaot-Xamarin.Kotlin.StdLib.dll.so\00", align 16
@__DSOCacheEntry_name.46 = internal constant [47 x i8] c"libaot-System.ComponentModel.Primitives.dll.so\00", align 16
@__DSOCacheEntry_name.47 = internal constant [42 x i8] c"libaot-Xamarin.AndroidX.Collection.dll.so\00", align 16
@__DSOCacheEntry_name.48 = internal constant [38 x i8] c"libaot-System.Runtime.Numerics.dll.so\00", align 16
@__DSOCacheEntry_name.49 = internal constant [45 x i8] c"libaot-System.Diagnostics.TraceSource.dll.so\00", align 16
@__DSOCacheEntry_name.50 = internal constant [26 x i8] c"libaot-netstandard.dll.so\00", align 16
@__DSOCacheEntry_name.51 = internal constant [38 x i8] c"libaot-DevExpress.Maui.Editors.dll.so\00", align 16
@__DSOCacheEntry_name.52 = internal constant [41 x i8] c"libaot-Xamarin.AndroidX.ViewPager.dll.so\00", align 16
@__DSOCacheEntry_name.53 = internal constant [36 x i8] c"libaot-CommunityToolkit.Mvvm.dll.so\00", align 16
@__DSOCacheEntry_name.54 = internal constant [41 x i8] c"libaot-Xamarin.AndroidX.AppCompat.dll.so\00", align 16
...
@dso_cache = local_unnamed_addr global [800 x %struct.DSOCacheEntry] [
	...
	; 1
	%struct.DSOCacheEntry {
		i64 75196885181753912, ; hash 0x10b272b2d796a38, from name: aot-ActualizacionClientesIdealMaui
		i8 0, ; ignore
		i8* getelementptr inbounds ([45 x i8], [45 x i8]* @__DSOCacheEntry_name.2, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 2
	%struct.DSOCacheEntry {
	...
	; 169
	%struct.DSOCacheEntry {
		i64 3753139764838986361, ; hash 0x3415d4bb2b9ef279, from name: libaot-ActualizacionClientesIdealMaui.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([45 x i8], [45 x i8]* @__DSOCacheEntry_name.2, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 205
	%struct.DSOCacheEntry {
		i64 4721778982721327012, ; hash 0x418720f7bd028fa4, from name: libaot-ActualizacionClientesIdealMaui
		i8 0, ; ignore
		i8* getelementptr inbounds ([45 x i8], [45 x i8]* @__DSOCacheEntry_name.2, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 354
	%struct.DSOCacheEntry {
		i64 8322573483333087497, ; hash 0x737fb87cfb277109, from name: ActualizacionClientesIdealMaui
		i8 0, ; ignore
		i8* getelementptr inbounds ([45 x i8], [45 x i8]* @__DSOCacheEntry_name.2, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 580
	%struct.DSOCacheEntry {
		i64 12994353882034944638, ; hash 0xb455380238693a7e, from name: ActualizacionClientesIdealMaui.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([45 x i8], [45 x i8]* @__DSOCacheEntry_name.2, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 725
	%struct.DSOCacheEntry {
		i64 16435188260066000687, ; hash 0xe41584a529e77f2f, from name: aot-ActualizacionClientesIdealMaui.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([45 x i8], [45 x i8]* @__DSOCacheEntry_name.2, i32 0, i32 0), ; name
		i8* null; handle
	}, 
